              ...
              <Card className="flex flex-col h-full">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex flex-col">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="flex flex-row gap-2 items-center py-1">
            ...
            <CardContent className="h-full">
              ...
              <div className="grid auto-rows-fr grid-cols-3 gap-4 h-full">
                {[...Array(3)].map((_, colIdx) => (
                  <div key={colIdx} className="rounded-lg border bg-background p-4 shadow-xs">
                    {/* Column Header */}
                    ...
                    <div className="flex flex-col gap-4 p-0.5">
                      {[...Array(2)].map((_, cardIdx) => (
                        <div key={cardIdx} className="rounded-md border bg-card p-3 shadow-xs">
                          {/* Item Images */}
                          <div className="flex gap-1 mb-2">
                            {[...Array(3)].map((_, imgIdx) => (
                              <Skeleton key={imgIdx} className="w-12 h-12 rounded-md" />
                            ))}
                          </div>
                          {/* Title and Shop */}
