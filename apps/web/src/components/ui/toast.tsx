...
function Toast({ className, swipeDirection = "up", ...props }: ToastPrimitive.Root.Props) {
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        "group/toast pointer-events-auto absolute inset-x-0 top-0 z-[calc(1000-var(--toast-index))] mx-auto w-full origin-top rounded-2xl border bg-popover text-popover-foreground shadow-lg will-change-transform outline-none select-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50",
