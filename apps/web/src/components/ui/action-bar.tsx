...
type ButtonClickEvent = Parameters<NonNullable<React.ComponentProps<typeof Button>["onClick"]>>[0];
type ButtonFocusEvent = Parameters<NonNullable<React.ComponentProps<typeof Button>["onFocus"]>>[0];
