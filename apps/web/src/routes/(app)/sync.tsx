                ...
                <div className="flex flex-col w-full gap-4">
                  ...
                  <Accordion type="single" collapsible className="px-2">
                    <AccordionItem value="item-1">
                      ...
                      <AccordionContent>
                        Since MyFigureCollection does not provide an API,
                        myakiba scrapes the item(s) information from
                        MyFigureCollection on user request. Our scraper is{" "}
                        <span className="font-bold text-primary">
                          heavily rate limited/throttled
                        </span>{" "}
                        to prevent MyFigureCollection's servers from ever being
                        overwhelmed by us. From what we can tell, this adheres
                        to MyFigureCollection's terms of service. Users are also
                        limited to syncing a few times per hour to prevent
                        abuse.
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent>
                        ...
                        MyFigureCollection's website, and cannot be scraped by
